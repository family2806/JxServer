...
--	Say("Íæ¼Ò£ºĞ¡Ğ¡Äê¼Í£¬µ¹Í¦ÓĞÖ¾Æø¡£",3,"TÆng mét mãn vò khİ /arm","TÆng mét chót b¹c /money","§Ó ta suy nghÜ kü l¹i xem/wait")
...
function money()
	if (GetCash() < 100) then
--		Say("Íæ¼Ò£º°¥Ñ½£¬ÎÒÉíÉÏÃ»´øÊ²Ã´Ç®¡£",3,"TÆng mét mãn vò khİ /arm","TÆng mét chót b¹c /money","§Ó ta suy nghÜ kü l¹i xem/wait")
		...
		SetTask(65,11)
		AddRepute(4)
		AddNote("T×m ®­îc Ng­u Ng­u, cho ®i mét mãn vò khİ, ñng hé ­íc m¬ lµm ®¹i hiÖp cña nã. ¡£Íê³ÉÈÎÎñ")
		Msg2Player("T×m ®­îc Ng­u Ng­u, cho ®i mét mãn vò khİ, ñng hé ­íc m¬ lµm ®¹i hiÖp cña nã. ¡£Íê³ÉÈÎÎñ")
