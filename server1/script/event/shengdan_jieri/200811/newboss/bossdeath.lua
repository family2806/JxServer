local tbAwardItem = 
{
	...
	{szName="Tiªn Th¶o Lé (Ð¡) ", nCount=5, tbProp={6, 1, 124, 1, 0, 0}},
	{szName="Tiªn Th¶o Lé (ÖÐ) ", nCount=5, tbProp={6, 1, 123, 1, 0, 0}},
	{szName="Tiªn Th¶o Lé (´ó) ", nCount=5, tbProp={6, 1, 122, 1, 0, 0}},
