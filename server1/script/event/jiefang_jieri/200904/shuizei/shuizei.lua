...
--·çÔÆÁîÅÆ - Íê³É1´ÎËÑ¼¯¹¦Ñ«ÁîµÄÈÎÎñ - Modified by DinhHQ - 20110920
...
function join_shuizei_act()
	...
	Say("ThuyÒn phu bê B¾c: D¹o nµy Thñy TÆc th­êng hoµnh hµnh b¸ ®¹o, c­íp bãc nhiÒu chiÕc thuyÒn qua l¹i 2 bê Phong L¨ng §é. Ng­¬i cã muèn thÕ thiªn hµnh ®¹o, tiªu diÖt nh÷ng tªn c­íp nµy kh«ng?",2,"Ta ®· cho chóng 1 bµi häc ®İch ®¸ng./join_shuizei_act_cf", "Ta ®ang rÊt bËn, khi kh¸c sÏ quay l¹i./OnCancel");
end
...
function submit_zhuigongling(nCount)
	...
	if (ng == 6 and nd == 1 and np == 2015) then
		...
		Say("ThuyÒn phu: Chóc mõng ®¹i hiÖp! §©y lµ phÇn th­ëng xøng ®¸ng dµnh cho vŞ anh hïng.", 0);
		--·çÔÆÁîÅÆ - Íê³É1´ÎËÑ¼¯¹¦Ñ«ÁîµÄÈÎÎñ - Modified by DinhHQ - 20110920
		G_ACTIVITY:OnMessage("FLD_Collect_Item_VNG");
		give_shuizei_award_exp();
	else
		Say("VËt phÈm b¹n ®Ó vµo kh«ng chİnh x¸c!", 2, "Xin lçi! Ta sÏ bá l¹i./give_shuizei_award_lingpai", "Ta sÏ quay l¹i sau/no");
	end
end
