...
function Soldier2010:SongjinSoldier(nPlayerIdx)
	...
	if (PlayerFunLib:CheckBT_PL_BATTLEPOINT(3000, ">=") == 1) then
		tbAwardTemplet:GiveAwardByList(FreedomEvent2010.tbSongjinSoldier, format("%s\t%s","Ho¹t ®éng tÊm ¸o chiÕn sü","PhÇn th­ëng khi cã ®iÓm tİch lòy Tèng Kim trªn 3000"));
	end
	PlayerIndex = nOldIdx;
end
