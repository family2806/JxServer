...
--		Say("¡¡¡¡·ç±©»î¶¯¿ª·ÅÈÕÆÚÎª9ÔÂ8ÈÕ-10ÔÂ2ÈÕ£¬°üÀ¨ËÎ½ğ´óÕ½¡¢Ò°ÛÅÈÎÎñÁ´¡¢É±ÊÖÊÔÁ¶ÈÎÎñ¡£Ã¿Ìì¸ù¾İÄãÔÚ¸÷¸öÏµÍ³ÖĞµÄ³É¼¨×ª»¯Îªcña b¹n·ç±©»ıphót£¨²Î¼ÓÌõ¼ş£º50¼¶¼°ÒÔÉÏÍæ¼Ò£©¡£<enter>"..
--		"¡¡¡¡Ã¿ÈÕ»ıphót½«ÔÚÃ¿ÈÕ<color=red>24£º00Çå¿Õ<color>£¬ÇëÔÚ24£º00Ç°ÁìÈ¡»ıphót½±Àø¡£<enter>"..
--		"¡¡¡¡Ã¿Ìì<color=red>23£º30<color>¿ªÊ¼µÄËÎ½ğ´óÕ½£¬³É¼¨²»¼ÆÈë·ç±©»ıphót¡£<enter>"..
...
function storm_calc_today(gameid, newpoint)
	...
	if (addpoint ~= 0) then
		if (gameid ~= 1 or (floor(todaypoint/5) > floor((todaypoint-addpoint)/5))) then	--ËÎ½ğÒª×ÜphótÔö¼Ó³¬¹ı5phót£¬¸æÖª»ıphótÇé¿ö
			Msg2Player("ÄãHiÖn t¹iµÄ·ç±©»ıphótÊÇ:"..storm_point2str(todaypoint))
		end
