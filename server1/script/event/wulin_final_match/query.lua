IncludeLib("LEAGUE")
function query()
	Say("Ng­¬i muèn xem tin tøc ThËp lôc ®Êu cña chiÕn ®éi nµo?", 4, "Tin tøc thi ®Êu cña m×nh/selfmatch", "Tin tøc thi ®Êu cña khu vùc m×nh/owntong", "Tin tøc thi ®Êu cña khu vùc kh¸c/whichtong", "Nh©n tiÖn ghÐ qua th«i/no");
end
