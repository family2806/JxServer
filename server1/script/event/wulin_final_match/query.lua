...
function owntong_DOUBLE()
	...
	Say("Ng­¬i muèn xem tin tøc Song Nh©n ®Êu cña chiÕn ®éi nµo?", 7, "Nhãm thø 1".."/#tonginfo(11,'"..owntongteamname.."1')", "Nhãm thø 2".."/#tonginfo(11,'"..owntongteamname.."2')", "Nhãm thø 3".."/#tonginfo(11,'"..owntongteamname.."3')", "Nhãm thø 4".."/#tonginfo(11,'"..owntongteamname.."4')", "Nhãm thø 5".."/#tonginfo(11,'"..owntongteamname.."5')", "Trang tr­íc/owntong_SINGLE", "§ãng/no");
end

function owntong_FIVE()
	local owntongteamname = getowntongname().."Ngò hµnh ®Êu";
	Say("ÄãÏë¿´ÄÄ¸öÕ½¶ÓµÄNgò hµnh ®Êu±ÈÈüÐÅÏ¢?", 5, "Nhãm thø 1".."/#tonginfo(12,'"..owntongteamname.."1')", "Nhãm thø 2".."/#tonginfo(12,'"..owntongteamname.."2')", "Nhãm thø 3".."/#tonginfo(12,'"..owntongteamname.."3')", "Trang tr­íc/owntong", "§ãng/no");
end

function owntong_TEN()
	local owntongteamname = getowntongname().."ThËp toµn ®Êu";
	Say("ÄãÏë¿´ÄÄ¸öÕ½¶ÓµÄThËp toµn ®Êu±ÈÈüÐÅÏ¢?", 4, "Nhãm thø 1".."/#tonginfo(13,'"..owntongteamname.."1')", "Nhãm thø 2".."/#tonginfo(13,'"..owntongteamname.."2')", "Trang tr­íc/owntong", "§ãng/no");
end

function owntong_SIXTEEN()
	local owntongteamname = getowntongname().."ThËp lôc ®Êu";
	Say("Ng­¬i muèn xem tin tøc thi ®Êu cña khu vùc nµo?", 4, "Nhãm thø 1".."/#tonginfo(14,'"..owntongteamname.."1')", "Nhãm thø 2".."/#tonginfo(14,'"..owntongteamname.."2')", "Trang tr­íc/owntong", "§ãng/no");
end
...
function othertong_DOUBLE(tongname)
	...
	Say("ÄãÏë¿´Song ®ÊuÄÄ¸öÕ½¶ÓÐÅÏ¢?", 7, "Nhãm thø 1".."/#tonginfo(11,'"..othertongteamname.."1')", "Nhãm thø 2".."/#tonginfo(11,'"..othertongteamname.."2')", "Nhãm thø 3".."/#tonginfo(11,'"..othertongteamname.."3')", "Nhãm thø 4".."/#tonginfo(11,'"..othertongteamname.."4')", "Nhãm thø 5".."/#tonginfo(11,'"..othertongteamname.."5')", "Trang tr­íc/#othertong('"..tongname.."')", "§ãng/no");
end

function othertong_FIVE(tongname)
	local othertongteamname = tongname.."Ngò hµnh ®Êu";
	Say("ÄãÏë¿´Ngò hµnh ®ÊuÄÄ¸öÕ½¶ÓÐÅÏ¢?", 5, "Nhãm thø 1".."/#tonginfo(12,'"..othertongteamname.."1')", "Nhãm thø 2".."/#tonginfo(12,'"..othertongteamname.."2')", "Nhãm thø 3".."/#tonginfo(12,'"..othertongteamname.."3')", "Trang tr­íc/#othertong('"..tongname.."')", "§ãng/no");
end

function othertong_TEN(tongname)
	local othertongteamname = tongname.."ThËp toµn ®Êu";
	Say("ÄãÏë¿´ThËp toµn ®ÊuÄÄ¸öÕ½¶ÓÐÅÏ¢?", 4, "Nhãm thø 1".."/#tonginfo(13,'"..othertongteamname.."1')", "Nhãm thø 2".."/#tonginfo(13,'"..othertongteamname.."2')", "Trang tr­íc/#othertong('"..tongname.."')", "§ãng/no");
end

function othertong_SIXTEEN(tongname)
	local othertongteamname = tongname.."ThËp lôc ®Êu";
	Say("ÄãÏë¿´ThËp lôc ®ÊuÄÄ¸öÕ½¶ÓµÄÐÅÏ¢?", 4, "Nhãm thø 1".."/#tonginfo(14,'"..othertongteamname.."1')", "Nhãm thø 2".."/#tonginfo(14,'"..othertongteamname.."2')", "Trang tr­íc/#othertong('"..tongname.."')", "§ãng/no");
end
...
function tonginfo(matchtype, tongname)
	...
	if ( position == 0 ) then
		...
		Say("Tªn cña chiÕn ®éi nµy lµ [<color=red>"..leaguename.."<color>], ®éi tr­ëng lµ <color=red>"..captain.."<color> hiÖn ®ang trong giai ®o¹n dù tuyÓn thi ®Êu, ®iÓm tÝch lòy lµ <color=red>"..mark.."<color>. §· qua <color=red>"..matchcount.."<color> trËn ®Êu, th¾ng <color=red>"..wincount.."<color> trËn, hßa <color=red>"..drawcount.."<color> trËn, b¹i <color=red>"..losecount.."<color> trËn. Thµnh viªn gåm"..num.."ng­êi, danh s¸ch nh­ sau:",getn(opp),opp );
	else
...
function selfmatch()
	...
	--Say("ÎäÁÖ´ó»á¹ÙÔ±£ºÄãÒª²éÑ¯×Ô¼ºµÄÄÄÏî±ÈÈüÄØ£¿", 7, "ÃÅÅÉµ¥ÏîÈü/#selfinfo(10)", "Ë«ÈËÈü/#selfinfo(11)", "ÎåÐÐÍÅ¶ÓÈü/#selfinfo(12)", "Ê®È«ÍÅ¶ÓÈü/#selfinfo(13)", "16ÈËÍÅ¶ÓÈü/#selfinfo(14)", "Trang tr­íc/query", "§ãng/no");
