...
function wl_getfactionsticket()
	...
	Say(" Ng­¬i cÇn vĞ vµo lo¹i h×nh thi ®Êu nµo?", getn(tabticket), tabticket);
end
...
--		Say("ÎäÁÖ´ó»á¹ÙÔ±£º¶Ô²»Æğ£¡Sè l­îng phiÕu t­ c¸ch tham gia lín nhÊt cña môc nµy lµ "..MAX_TICKETCOUNT..",ÄúÒÑ¾­ÁìÍê¸ÃÏîÈüµÄ×Ê¸ñÆ±ÁË£¬²»ÄÜÔÙÁìÁË¡£",0)
--		return
--	end
...
--	if (usedcount >= MAX_TICKETCOUNT) then
--		Say("ÎäÁÖ´ó»á¹ÙÔ±£º¶Ô²»Æğ£¡".."Sè l­îng phiÕu t­ c¸ch tham gia lín nhÊt cña môc nµy lµ <color=yellow> "..MAX_TICKETCOUNT.." <color>,ÄúÒÑ¾­ÁìÍê¸ÃÏîÈüµÄ×Ê¸ñÆ±ÁË£¬²»ÄÜÔÙÁìÁË¡£",0)
--		return
--	end
