...
function wl_FinalTakeMatch( nTaskID, nCount )
	...
	--Èç¹ûÊÇÃÅÅÉµ¥ÏîÈüQu¸n qu©nÔò½±ÀøÊÇ¹Ì¶¨µÄ ´ó»Æ½ğ×°±¸
	...
	--Èç¹ûÊÇË«ÈËÈüµÄ»òÕßÎåĞĞÈüµÄQu¸n qu©nÔò£¬Ã¿ÈË»¹ÓĞÒ»¼şËæ»úµÄ´ó»Æ½ğ
...
function wulin_awardmain()
	...
	if (nowday >= WL_ZONEAWARD_TIME[1] and nowday <= WL_ZONEAWARD_TIME[2]) then
		if (count > 0 ) then --Çø·şÖĞÓĞ»ñµÃ¹Ú¡¢ÑÇ¡¢H¹ng 3£¬Ôò
...
function wl_want2doubleexp_30( taskid, count )	--ÁìÈ¡¸ qu©n½±Àø
