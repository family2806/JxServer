...
function wulin_watchticketmain()
	...
	--Èç¹ûÏÖÔÚ»¹Ã»ÓĞµ½µ±ÈÕµÄÂòÆ±Ê±¼ä£¬ÔòÄ¿Ç°¶ÒµÄ½±Îª×òÌìµÄ½±
	print("sadbeginf")
	if ( nowhour < 20) then
		local yesterday = today - 1
		local idx = wulin_day2buytabidx(yesterday)

		--Èç¹û×òÌìÃ»ÓĞÂô¹ıÆ±£¬Ôò²»¶Ò½±ÁË£¬Ä¿Ç°µÄÆ±Ò²×ÔÈ»ÊÇ¹ıÆÚµÄ¡£
		if (idx == 0) then
			bCheckTicket1 = 0
			bCheckTicket2 = 0
			wulin_clearticket()
		else
			--ÉÏ´ÎÂòµÄÆ±ÒÑ¾­¹ıÆÚÔòÇå³ı£¬
			print("now match1")
		...
		--Èç¹ûÏÖÔÚµ½ÁËµ±ÈÕµÄÂò½±»ò¿ª½±Ê±¼ä£¬ÔòÈç¹ûÏÖÔÚÊÇ21£º00 > and  < 23£¬ÔòÄ¿Ç°¶ÒµÄ½±ÊÇ±¾ÈÕµÚÒ»ÆÚ£¬Èç¹û> 23Ôò¶ÒµÄÊÇ±¾ÈÕµÚÒ»¡¢µÚ¶şÆÚµÄ
		
		--Èç¹ûÉÏ´ÎÂòµÄÆ±²»ÊÇ½ñÌìµÄÆ±£¬Ôò¹ıÆÚÁË£¬Çå³ı
	...
	if (nowhour == 20 or nowhour == 22) then
		...
		--Èç¹ûÍæ¼Òµ±Ç°µÄÆ±ÒÑ¾­ÊÇ¹ıÆÚµÄÁË£¬ÄÇÃ´Çå³ıÕâĞ©Æ±
