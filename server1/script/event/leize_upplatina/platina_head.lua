...
TB_PLATINAEQ_GOLDEQ ={
--[°×½ðID] = {»Æ½ðID,×°±¸Éý¼¶¼ÛÖµÁ¿ÏµÊý,×°±¸Ãû, ÊÇ·ñÐèÒªHçn ®én ®Ünh};
...
[1] = {
				...
				szErrorMsg = "<dec><npc>³ý<color=yellow>»Æ½ð×°±¸Ö®Íâ<color>, Ö»ÓÐ<color=yellow>L«i Tr¹ch Chïy<color>ÊÇÎÒÃÇÐèÒªµÄÎïÆ·£¬Çë°Ñ±ðµÄÎïÆ·´ø×ß!",
				nItemQuality = 1,
