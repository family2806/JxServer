...
function tbJinWuRefineEquip:ComposeGiveUI()
	...
	local szTitle = format("  %-15s\t%s", "Trang bÞ Kim ¤", "Ngäc Trïng LuyÖn Kim ¤")
...
function tbJinWuRefineEquip:Compose(nComposeCount)
	...
	-- È¡µÃNgäc Trïng LuyÖn Kim ¤µÄÊýÁ¿
...
function refine_jinwu()
	...
	local strDesc = "<npc>ÄÃ <color=yellow>Trang bÞ Kim ¤<color> ÒªÖØÁ·µÄºÍÊýÁ¿<color=yellow> Ngäc Trïng LuyÖn Kim ¤<color> ÏàÓ¦µÄ·ÅÈëÏÂÃæ"
	strDesc = strDesc..format("\n\t\t\t\t\t%-29s%s", "Trang bÞ Kim ¤", "Ngäc Trïng LuyÖn Kim ¤")
