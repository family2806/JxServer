...
function funv_jieri_shenmi:xianhua()
	...
	Say("各位大侠要送我什么花呢？",3,"我想送玫瑰花./#funv_jieri_shenmi:zengsongmeigui(1)","我想送菊花./#funv_jieri_shenmi:zengsongjuhua(1)","离开/NoChoice")
end
...
function funv_jieri_shenmi:zengsongjuhua(sel)
	...
	if ntaskjuhua >= tbjuhua.limit then
		Say("每个人物最多只能送给2个密件任务人物125束菊花.",0)
		return
	end
