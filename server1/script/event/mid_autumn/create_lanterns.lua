IncludeLib("FILESYS")
tbLANTERNS_NPC = {
		{ 2, 36, 280, 560,		"\\settings\\event\\zhongqiuhuodong\\huashan_lantern.txt",		"\\script\\event\\mid_autumn\\lantern.lua", "华山" },
		{ 21, 37, 550, 1100,	"\\settings\\event\\zhongqiuhuodong\\qingcheng_lantern.txt",	"\\script\\event\\mid_autumn\\lantern.lua", "青城山" },
		{ 167, 38, 330, 660,	"\\settings\\event\\zhongqiuhuodong\\diancang_lantern.txt",		"\\script\\event\\mid_autumn\\lantern.lua", "点苍山" },
		{ 193, 39, 340, 680,	"\\settings\\event\\zhongqiuhuodong\\wuyi_lantern.txt",			"\\script\\event\\mid_autumn\\lantern.lua", "武夷山" },
}
