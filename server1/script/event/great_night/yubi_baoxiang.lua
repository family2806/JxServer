...
-- ½£ÏÀÇéÔµÍøÂç°æÔ½ÄÏÊÕ·Ñ°æ - Ngäc BÝch B¶o R­¬ng
...
--ÔÚÊ¹ÓÃ¸÷Àà±¦ÏäÊ±£¬¾­ÑéÖµÏÞÖÆÊÇ3ÒÚ. - Modified by DinhHQ - 20110428
...
function main(nIndexItem)
	...
	-- ÅÐ¶¨Ch×a Khãa Nh­ ýÊÇ·ñ´æÔÚ
	local nCount = CalcItemCount(3, 6, 1, 2744, -1) 
	if nCount == 0 then
		Say("ÒªÓÐCh×a Khãa Nh­ ý²Å¿ÉÒÔ´ò¿ªNgäc BÝch B¶o R­¬ng", 1, "§ãng/no")
		return 1
	end
	...
	if ConsumeItem(3, 1, 6, 1, 2744, -1) == 1 then	-- ÏûºÄCh×a Khãa Nh­ ý
