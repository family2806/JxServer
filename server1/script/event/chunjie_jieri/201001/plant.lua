...
tbAwardList = {
	...
	[1] = {30000000,	25000000,	20000000,	0},		-- Mai Tr­êng Thä
	[2]	= {20000000,	15000000,	10000000,	0},		-- Mai An Khang
	[3] = {10000000,	8000000,	6000000,	0},		-- Mai ThÞnh V­îng
	[4] = {8000000,		6000000,	4000000,	0},		-- Mai H¹nh Phóc
	[5] = {6000000,		4000000,	3000000,	0},		-- Mai Tµi Phó
}
...
function tbSeed:Grow(Kind)
	...
	PlayerIndex = player
	-- Èç¹ûÊÇ"Mai An Khang"»ò"Mai Tr­êng Thä"£¬¾ÍÈ«²¿ÆµµÀÍ¨¸æ
...
tbMaintainInfo = {
	...
	[4] = {
		Dlg = "B¾t s©u cho c©y",
		Msg = "ÔÙ¼ÌÐøB¾t s©u cho c©y",
		Err = "´óÏÀÒÑ¾­B¾t s©u cho c©yÁË",
		Npc = 1532,
		},
	[5] = {
		Dlg = "TrÈy l¸ cho c©y",
		Msg = "ÔÙTrÈy l¸ cho c©y",
