...
{
    [1] = {["nTemplate"] = 92, ["nSubworld"] = 897, ["nx"] = 52064, ["ny"] = 104064, ["strScript"] = "\\script\\honor\\honor_master.lua", ["strNpcName"] = "ÌÃÌÃÖ÷ÃûÈË",},
	[2] = {["nTemplate"] = 393, ["nSubworld"] = 897, ["nx"] = 49472, ["ny"] = 105888, ["strScript"] = "\\script\\tong\\npc\\tong_chefu.lua", ["strNpcName"] = "³µ·ò",},
	[3] = {["nTemplate"] = 625, ["nSubworld"] = 897, ["nx"] = 50368, ["ny"] = 106816, ["strScript"] = "\\script\\tong\\npc\\tong_chuwuxiang.lua", ["strNpcName"] = "´¢ÎïÏä®å",},
}

-- ÅÅÃûµñÏñnpcÐÎÏóÄ£°å
tbHonor_Sys_2009.tbNPC_Template_List = 
{
    [255] = {[0]=1415, [1]=1423, strName = "Kh«ng m«n ph¸i"}, -- key ÃÅÅÉid; 0 ÄÐ, 1 Å® Kh«ng m«n ph¸i Ä¬ÈÏÓÃThiªn V­¬ngµÄµñÏñ
    [-1] = {[0]=1415, [1]=1423, strName = "Kh«ng m«n ph¸i"}, -- key ÃÅÅÉid; 0 ÄÐ, 1 Å® Kh«ng m«n ph¸i Ä¬ÈÏÓÃThiªn V­¬ngµÄµñÏñ
	[0] = {[0]=1422, [1]=1422, strName = "ThiÕu L©m"}, -- key ÃÅÅÉid; 0 ÄÐ, 1 Å® ThiÕu L©m
	[1] = {[0]=1421, [1]=1420, strName = "Thiªn V­¬ng"}, -- key ÃÅÅÉid; 0 ÄÐ, 1 Å® Thiªn V­¬ng
	[2] = {[0]=1417, [1]=1416, strName = "§­êng M«n"}, -- key ÃÅÅÉid; 0 ÄÐ, 1 Å® Ngò §éc
	[3] = {[0]=1415, [1]=1414, strName = "Ngò §éc"}, -- key ÃÅÅÉid; 0 ÄÐ, 1 Å® §­êng M«n
	[4] = {[0]=1423, [1]=1423, strName = "Nga My"}, -- key ÃÅÅÉid; 0 ÄÐ, 1 Å® Nga My
	[5] = {[0]=1428, [1]=1428, strName = "Thóy Yªn"}, -- key ÃÅÅÉid; 0 ÄÐ, 1 Å® Thóy Yªn
	[6] = {[0]=1413, [1]=1412, strName = "C¸i Bang"}, -- key ÃÅÅÉid; 0 ÄÐ, 1 Å® C¸i Bang
	[7] = {[0]=1419, [1]=1418, strName = "Thiªn NhÉn"}, -- key ÃÅÅÉid; 0 ÄÐ, 1 Å® Thiªn NhÉn
	[8] = {[0]=1427, [1]=1426, strName = "Vâ §ang"}, -- key ÃÅÅÉid; 0 ÄÐ, 1 Å® Vâ §ang
	[9] = {[0]=1425, [1]=1424, strName = "C«n L«n"}, -- key ÃÅÅÉid; 0 ÄÐ, 1 Å® C«n L«n
	[10] = {[0]=1430, [1]=1429, strName = "Thiªn Tö"}, -- 0 ÄÐ, 1 Å® Thiªn Tö
}
