...
TEMBUGBEAR_EXP =tonumber( TabFile_GetCell( "tollprize" ,5 ,"bug_exp"))  --小怪经验
TEMBUGBEAR_MAPID= 390  --山神庙的地图id
TEMBUGBEAR_MESSENGEREXP=tonumber( TabFile_GetCell( "tollprize" ,5 ,"bug_jifen"))  --小怪经验
