...
TEMREFRESH_EXP = tonumber( TabFile_GetCell( "tollprize" ,7 ,"shuachu_exp"))  --小怪经验
TEMREFRESH_MAPID= 392  --山神庙的地图id
TEMREFRESH_MESSENGEREXP= tonumber( TabFile_GetCell( "tollprize" ,7 ,"shuachu_jifen"))  --小怪经验
