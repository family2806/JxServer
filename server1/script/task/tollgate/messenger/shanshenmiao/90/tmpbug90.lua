...
TEMBUGBEAR_EXP =tonumber( TabFile_GetCell( "tollprize" ,7 ,"bug_exp"))  --小怪经验
TEMBUGBEAR_MAPID= 392  --山神庙的地图id
TEMBUGBEAR_MESSENGEREXP= tonumber( TabFile_GetCell( "tollprize" ,7 ,"bug_jifen"))  --小怪经验
