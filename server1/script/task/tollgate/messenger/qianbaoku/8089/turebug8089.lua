...
TUREBUGBEAR_EXP =tonumber( TabFile_GetCell( "tollprize" ,9 ,"bug_exp"))  --小怪经验
TUREBUGBEAR_MAPID= 394  --千宝库的地图id
TUREBUGBEAR_MESSENGEREXP= tonumber( TabFile_GetCell( "tollprize" ,9 ,"bug_jifen"))  --小怪经验
