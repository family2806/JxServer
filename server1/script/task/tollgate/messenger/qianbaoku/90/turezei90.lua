...
TUREREFRESH_EXP = tonumber( TabFile_GetCell( "tollprize" ,10 ,"shuachu_exp"))  --小怪经验
TUREREFRESH_MAPID= 395  --千宝库的地图id
TUREREFRESH_MESSENGEREXP= tonumber( TabFile_GetCell( "tollprize" ,10 ,"shuachu_jifen"))  --小怪经验
