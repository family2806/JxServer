...
function ExChangeItem_main()
	...
	tinsert(tbOpp,"Vßng Hoa Quèc Kh¸nh(1 Hoa Cóc Vµng + 1 Hoa Cóc Tr¾ng + 1 Hoa Cóc TÝm + 2 Íò)/#DoExChangeItem(1)");
	tinsert(tbOpp,"Vßng Hoa §éc LËp(1 Hoa Cóc Vµng + 1 Hoa Cóc Tr¾ng + 1 Hoa Cóc TÝm + 1 ºìHoa Hång)/#DoExChangeItem(2)");
	tinsert(tbOpp,"Vßng Hoa Tù Do((1 Hoa Cóc Vµng + 1 Hoa Cóc Tr¾ng + 1 Hoa Cóc TÝm + 1 ºìHoa Hång)/#DoExChangeItem(3)");
