...
if (UTask_tm == 70*256) then					--ÌÆÃÅÒÑ¾­³öÊ¦		
	Say("Th× ra lµ ®ång m«n tr­íc ®©y, cã chuyÖn g× thÕ?", 4, "T×m hiÓu l¹i §­êng M«n/org", "T×m hiÓu l¹i ®ång m«n tr­íc kia/member", "T×m hiÓu l¹i bè côc n¬i nµy/config", "Cßn nhiÖm vô nµo ®Ó lµm n÷a/task3")
	return
end;	

Say("Ta ®· ë §­êng m«n m­êi mÊy n¨m nay, kh«ng chuyÖn g× kh«ng biÕt! Ng­¬i muèn hái g×?", 4, "§èi tho¹i víi Long Ngò /Uworld1000_word", "T×m hiÓu bæn m«n/org", "T×m hiÓu bè côc n¬i nµy/config", "T×m hiÓu bè côc n¬i nµy/config")
...
function task1()
Say("Bæn m«n chØ thu nhËn §Ö tö hÖ Méc, kh«ng ph©n nam n÷. Muèn nhËp m«n häc nghÖ, cÇn th«ng qua nhiÖm vô nhËp m«n.")
end;


function task2()
Say("<#> Ng­¬i ®· xuÊt s­, kh«ng cÇn lµm nhiÖm vô bæn m«n n÷a,  kı hiÖu nhiÖm vô lµ ", 0)
end;
