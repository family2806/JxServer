--description: §­êng M«nÌÆ³ğ 20¼¶ÈÎÎñ¡¢³öÊ¦ÈÎÎñ 
--author: yuanlan	
--date: 2003/3/11
...
function goff_yes()
	...
	Msg2Player("Ra khái §­êng m«n, l¹i ®i hµnh tÈu giang hå. ")
	SetFaction("")
	SetCamp(4)
	SetCurCamp(4)
end
...
-- Ë¢µô¼¼ÄÜ
	...
	i=43; x = HaveMagic(i); if (x ~= -1) then n = n + x end; DelMagic(i)			-- §­êng M«n°µÆ÷
	i=44; x = HaveMagic(i); if (x ~= -1) then n = n + x end; DelMagic(i)			-- §­êng M«nµ¶·¨
...
--	AddGlobalCountNews(GetName().."ÒÕ³É³öÊ¦£¬¸æ±ğ¸÷Î»Í¬ÃÅĞĞ×ß½­ºş¡£", 1)
	...
	SetRank(66)
	SetTask(2, 70*256)
	SetFaction("")				    			--Íæ¼ÒÍË³ö§­êng M«n
	SetCamp(4)
	SetCurCamp(4)
	AddNote("·µ»Ø§­êng M«n£¬½»ÆßĞÇ¾øÃü½£¸øÌÆ³ğÕÆÃÅ£¬Íê³É³öÊ¦ÈÎÎñ£¬ÉıÎªÌìÊØÉñÎÀ ")
end;
