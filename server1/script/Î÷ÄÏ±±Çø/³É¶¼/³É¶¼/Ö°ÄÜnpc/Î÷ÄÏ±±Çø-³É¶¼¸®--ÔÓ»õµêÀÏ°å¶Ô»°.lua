...
Say("§ïi gµ n­íng cßn nãng hái võa míi lÊy trong bÕp. 50 l­îng b¹c mét c¸i, cã muèn lÊy kh«ng?", 3, "Ta muèn mua mét c¸i ®ïi gµ. /chicken", "Ta muèn mua hµng hãa kh¸c /yes", "Kh«ng giao dÞch/no")
	...
	elseif (UTask_tm == 10*256+40) then		--ÌÆÃÅÌÆº×10¼¶ÈÎÎñ
		Say("ChiÕc nhÉn m· n·o nµy rÊt ®Ñp, 500 l­¬ng b¹c mét chiÕc. Kh«ng mua sÏ hèi hËn!", 3, "Mua nhÉn M· n·o. /ring", "Ta muèn mua hµng hãa kh¸c /yes", "Kh«ng giao dÞch/no")
	else
		local Buttons = store_sel_extend();
		Say("§ïi gµ n­íng cßn nãng hái võa míi lÊy trong bÕp. 50 l­îng b¹c mét c¸i, cã muèn lÊy kh«ng?", getn(Buttons), Buttons);
	end
end;
