		...
		["ThiÖp Xu©n2"] = 
			{
				tbFormula = 
					{
						szComposeTitle = format("Ho¹t ®éng lµm b¸nh ®ãn xu©n\t Hîp thµnh %s", "ThiÖp Xu©n2"),
						nWidth = 1,
						nHeight = 1,
						nFreeItemCellLimit = 0.02,
						tbMaterial = 
		...
		["ThiÖp Xu©n3"] = 
			{
				tbFormula = 
					{
						szComposeTitle = format("Ho¹t ®éng lµm b¸nh ®ãn xu©n\t Hîp thµnh %s", "ThiÖp Xu©n3"),
						nWidth = 1,
						nHeight = 1,
						nFreeItemCellLimit = 0.02,
						tbMaterial = 
...
function main()
	...
	tbMainDialog.szTitleMsg = "ÒÔ<color=red>1 <color>Tinh Hång B¶o Th¹ch,<color=red>1 <color>¸£ÔµÂ¶(´ó )  Æ¿ºÍ<color=red>1 <color>ÆäÖÐÒ»ÖÖË®¾§Äã½«ÂíÉÏ»ñµÃÒ»ÕÅÆ¯ÁÁµÄThiÖp Xu©n."
	tbMainDialog:AddOptEntry("ÓÃLam Thñy TinhÂò¿¨", tbCardShop.buyCard, {tbCardShop,"ThiÖp Xu©n 1"})
	tbMainDialog:AddOptEntry("ÓÃTö Thñy Tinh¿¨", tbCardShop.buyCard, {tbCardShop, "ThiÖp Xu©n2"})
	tbMainDialog:AddOptEntry("ÓÃLôc Thñy Tinh¿¨", tbCardShop.buyCard, {tbCardShop, "ThiÖp Xu©n3"})
	tbMainDialog:Show()
end
