...
tbTrainSkill150.tbBIT_MIJI19 = {nTaskID = 3081,nStartBit = 1, nBitCount = 2, nMaxValue = 2};    --150¼¼ÄÜÃØ¼® 19¼¶
tbTrainSkill150.tbBIT_MIJI20 = {nTaskID = 3081,nStartBit = 3, nBitCount = 2, nMaxValue = 2};    --150¼¼ÄÜÃØ¼® 20¼¶

tbTrainSkill150.tbBIT_TCVA = {nTaskID = 3082,nStartBit = 1, nBitCount = 2, nMaxValue = 2};    --Task ±£Áô´³¹ØÐÞÁ¶´ÎÊý
tbTrainSkill150.tbBIT_TCVD = {nTaskID = 3082,nStartBit = 3, nBitCount = 2, nMaxValue = 2};    --Task ±£ÁôÑ×µÛ´³¹ØÐÞÁ¶´ÎÊý ®Õ 
tbTrainSkill150.tbBIT_TCTTMC = {nTaskID = 3082,nStartBit = 5, nBitCount = 2, nMaxValue = 2};	    --Task ±£ÁôÌì³ØÃØ¾³´³¹ØÐÞÁ¶´ÎÊý 
tbTrainSkill150.tbBIT_BCH_USE = {nTaskID = 3082,nStartBit = 7, nBitCount = 6, nMaxValue = 20};			-- Task °×¾ÔÍè¼¼ÄÜitemÊ¹ÓÃ´ÎÊý
tbTrainSkill150.tbBIT_Free_Use = {nTaskID = 2902,nStartBit = 1, nBitCount = 6, nMaxValue = 60};			-- Task ±£Áôµ±ÈÕÃâ·ÑÊ¹ÓÃ´ÎÊý
tbTrainSkill150.tbBIT_Fee_Use = {nTaskID = 2902,nStartBit = 7, nBitCount = 6, nMaxValue = 60};			-- Task ±£Áôµ±ÈÕÃâ·ÑÊ¹ÓÃ´ÎÊý
--tbTrainSkill150.TSK_CHANGE_DAY = 3083;     --Task ±£Áô¼ì²éreset
tbTrainSkill150.TSK_DAILY_CHANGE = 3082;  --Task reset°´ÈÕ
tbTrainSkill150.TSK_DAILY_USE = 2902		--Task reset °´ÈÕ
tbTrainSkill150.TSK_CHANGE_DAY = 2903;     --Task ±£Áô¼ì²éreset
