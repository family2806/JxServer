...
function main(nItemIdx)
	...
	tb.tbLog={"BaoRuongKimO"," π”√BaoRuongKimO"}
...
function GetDesc(nItem)	
	...
	local tbItemName = 
	{
		[1] = "B∂o R≠¨ng Kim § Hπng Li™n",
		[2] = "B∂o R≠¨ng Kim § Kh´i",	
		[3] = "B∂o R≠¨ng Kim § Th≠Óng GiÌi",
		[4] = "B∂o R≠¨ng Kim § HÈ Uy”n",
		[5] = "B∂o R≠¨ng Kim § Y™u ß∏i",
		[6] = "B∂o R≠¨ng Kim § Y",		
		[7] = "B∂o R≠¨ng Kim § VÚ Kh›",
		[8] = "B∂o R≠¨ng Kim § Hµi",
		[9] = "B∂o R≠¨ng Kim § BÈi",
		[10] = "B∂o R≠¨ng Kim § Hπ GiÌi",
	}
