...
function add_face()
	...
	--Ð´Ò»¸ö·ÅÈë½çÃæ
	GiveItemUI("H·y ®­a vµo 1 mÆt n¹", "ÒÑ¾­H·y ®­a vµo 1 mÆt n¹£¬µÈÎÞË«É±Õó·¢»Ó×÷ÓÃ¾Í»á±ä³ÉÏ£ÍûµÄÑù×Ó", "add_ui_confirm", "no");
end;
...
function removeface()
	...
	Say("ÏëÒªHñy báÄÇ¸öÄ£ÐÍ?", getn(tab_sel), tab_sel);
end;
...
function deloneface(nIdx)
	...
	Msg2Player("Hñy bá1¸ö°ï»áµÄÎÞË«É±ÕóÄ£ÐÍ.");
end;
-------------------------------------------------------------
--¶ÍÎä»ê-----
...
function stunt_wushenbless1()
	...
	if (nItemIdx > 0) then
		...
		SetTask(TASKID_STUNT_LASTDAY, getRelativeDay(nTongID))
		SetTask(TASKID_STUNT_TAKED, GetTask(TASKID_STUNT_TAKED) + 1)
		totempole_dec("µÃµ½<color=yellow>ÎäÉñ´Í¸£<color>, Ê¹ÓÃÖ®ºó½«µÃµ½2Ð¡Ê±µÄË«±¶¹±Ï×Öµ(Ö»¶ÔËÎKim»î¶¯£¬ÐÅÊ¹ÈÎÎñ£¬ÌôÕ½Ê±¼ä£¬ÎäÁÖÁ¬¶·£¬É±Ôô£¬»Ô»ÍÖ®Ò¹).")
	else
