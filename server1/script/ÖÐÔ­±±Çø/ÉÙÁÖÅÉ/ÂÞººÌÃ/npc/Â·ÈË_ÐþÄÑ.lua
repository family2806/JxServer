...
--		SetTask(122,255)
   ...
   elseif (Uworld122 == 70) then
   	Talk(7,"U122_prise","……","……","§¹i s­?","°¥Ñ½£¬……£¬ÎÒ²»¸Ò°¡!","Ai da! §¹i s­! Ta kh«ng d¸m nhËn ®©u!","……¸Ò×÷¸Òµ±£¬Ğ¡×Ó°İ·ş.")
	else
...
function U122_prise()
   if(GetTask(7) >= 70*256) and (GetTask(7) ~= 75*256) then			-- ÊÇÌìÍõµÜ×Ó»ò³öÊ¦µÜ×Ó
		Talk(2,"HuyÒn Nan: Kim quèc ®ang tiÕp tôc ®éng binh, vâ l©m Trung Nguyªn sÏ l¹i cã mét phen kinh thiªn ®éng ®Şa. ë ®©y l·o t¨ng cã mét quyÓn 'ThiÕu L©m TuyÖt kü', tÆng cho tiÓu h÷u, hy väng ng­¬i ch¨m chØ luyÖn c«ng, kh«ng chØ trë thµnh ®Ö tö cña bæn tù mµ cß cã thÓ lµ ","……µÄ·Ô¸À£¬Ğ¡×ÓÔõÃ´²»¸Ò×ñ´Ó!")
