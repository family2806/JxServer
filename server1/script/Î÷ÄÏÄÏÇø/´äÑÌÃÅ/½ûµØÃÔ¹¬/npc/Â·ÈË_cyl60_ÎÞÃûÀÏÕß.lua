...
function L60_talk4()
	Talk(6,"L60_talk5","Kh«ng ngê sau khi nghe ta nãi nµng kh«ng cã mét biÓu hiÖn g×, chØ nãi duy nhÊt mét c©u: 'Ng­¬i ®i ®i! Ta muèn quªn hÕt c¸c ng­êi'!","ThÕ «ng l·o cã ®i kh«ng?","Ta cßn cã thÓ ®i ®©u ®­îc? Con tim ta ®· trãt trao cho nµng, ta cßn cã thÓ ®i ®©u? T×m ®­îc n¬i nµy, ta ë l¹i ®©y lu«n, hy väng mét ngµy nµng sÏ tha thø cho ta! ")
end;
