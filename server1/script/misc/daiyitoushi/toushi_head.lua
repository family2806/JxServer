...
TB_TOUSHI_ERR_MSG			= 							-- ´íÎóÌáÊ¾ÐÅÏ¢
	{
		...
		[TOUSHI_FLAGERR]		= "<dec><npc>Ïë¼ÓÈë±¾°ï£¬ÄãµÄCh­ëng m«nÍ¬ÒâÁËÂð?",
		...
		[TOUSHI_MALEERR]		= "<dec><npc> <sex> ÒÑÕÒµ½ÕâÀï£¬Ò»¶¨Ò²ÖªµÀCh­ëng m«nµÄËùÓÐÊÂÇé¡£µ«ÊÇ£¬Äã²»·ûºÏ¼ÓÈëÃÅÅÉ.",
		[TOUSHI_TWFEMALEERR]	= "<dec><npc>ÄãÒÀÈ»Ã»ÓÐ±¾Bang chñ µÄÐÅÎï£¬²»ÄÜ¼ÓÈëÃÅÅÉ.",
