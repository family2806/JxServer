...
function GetBonusFirstWeek()
	...
	if (nHour >= 0 and nHour <=1400 ) then
		...
		-- Add 50 van luong
			Earn(500000)
			Msg2Player("B¹n nhËn ®­îc 50 ÍòÁ½");
			WriteLog(date("%Y%m%d %H%M%S").."\t".."An Bang Hoµng Kim LÖnh"..GetAccount().."\t"..GetName().."\t".."NhËn th­ëng Daily nhËn ®­îc 50 ÍòÁ½")
	...
	if (nHour > 1400 and nHour <=2400 ) then
			...
			if (nTongID ~= 0) then
				...
				Msg2Player("B¹n nhËn ®­îc 2000 °ï»á¹±Ï×Öµ");
				WriteLog(date("%Y%m%d %H%M%S").."\t".."An Bang Hoµng Kim LÖnh"..GetAccount().."\t"..GetName().."\t".."NhËn th­ëng Daily nhËn ®­îc 2000 °ï»á¹±Ï×Öµ")
			end
...
function GetBonusEndWeek()
		...
		if (nHour >= 0 and nHour <=1400 ) then
				...
				WriteLog(date("%Y%m%d %H%M%S").."\t".."An Bang Hoµng Kim LÖnh"..GetAccount().."\t"..GetName().."\t".."NhËn th­ëng Daily nhËn ®­îc 100 ÍòÁ½")
				--Add 3 qua huy hoang
				for i=1,3 do
				...
				-- add 1 mat na nguyen soai
					...
					-- add 5000 diem cong hien BH
						...
						if (nTongID ~= 0) then
							...
							Msg2Player("B¹n nhËn ®­îc 5000 °ï»á¹±Ï×Öµ");
							WriteLog(date("%Y%m%d %H%M%S").."\t".."An Bang Hoµng Kim LÖnh"..GetAccount().."\t"..GetName().."\t".."NhËn th­ëng Daily nhËn ®­îc 5000 °ï»á¹±Ï×Öµ")
						end
