...
function marshal_down(camp)
	...
	if (camp == 1) then
		...
		Msg2MSAll(MISSIONID, "<color=0x00FFFF>ËÎ½ğÕ½±¨: Nguyªn So¸i phe TèngÒÑ³öÏÖ")
	else
		...
		Msg2MSAll(MISSIONID, "<color=0x9BFF9B>ËÎ½ğÕ½±¨: Nguyªn So¸i phe KimÒÑ³öÏÖ")
	end		
end