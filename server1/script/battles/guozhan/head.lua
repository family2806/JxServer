...
MS_MARSHAL = 2;--¼ÇÂ¼µ±Ç°²úÉúµÄÊÇPhe TèngÔªË§£º1£»»¹ÊÇPhe KimÔªË§£º2£»»¹ÊÇ¶¼²úÉúÁË£º3£»
...
--	end
	...
	--end 
	--by zero 2007-7-30 »ñµÃËÎPhe Kim¹¦ÅÆ Ò»Ìì»ñµÃ2´Î
	...
	for i=1,getn(Win_Players_Table) do
        ...
        local n_bonuscff1 = 0;
			...
			Say("¹§Ï²¹ó·½È¡µÃÊ¤Àû! Danh väng cña b¹n t¨ng thªm  <color=yellow>"..repute.."<color>! Vµ nhËn thªm <color=yellow>"..n_bonuscff1.."<color> ®iÓm tÝch lòy", 1, "KÕt thóc ®èi tho¹i/#storm_end(1)")
