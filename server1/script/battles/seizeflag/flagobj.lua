...
if (GetMissionV(MS_FLAGMODE) == 1) then
	...
	if (GetCurCamp() == 1) then
		Msg2MSAll(MISSIONID, "<color=0x00FFFF> phe Tèng <color=yellow>"..GetName().."<color=0x00FFFF> t¹i <color=yellow>"..floor(X1/8)..","..floor(Y1/16).."<color=0x00FFFF>Î»ÖÃ¶áÈ¡Ë§Æì,Ä¿Ç°ÕıÇ°Íù<color=yellow>"..floor(x/(32*8))..","..floor(y/(32*16)))
		...
		Msg2MSAll(MISSIONID, "<color=0x9BFF9B> phe Kim <color=yellow>"..GetName().."<color=0x9BFF9B> t¹i <color=yellow>"..floor(X1/8)..","..floor(Y1/16).."<color=0x9BFF9B>Î»ÖÃ¶áÈ¡Ë§Æì,Ä¿Ç°ÕıÇ°Íù<color=yellow>"..floor(x/(32*8))..","..floor(y/(32*16)))
