...
-------------------------------------------------------------------------
	...
	x,y = bt_str2xydata(transportxy)
	bt_add_a_diagnpc(FILE_TRANSPORT2, TNPC_TRANSPORT2, x * 32, y * 32, "侦查金军前线﹏");
	...
	local str1 = lvlstr.."宋金战役情形消灭BOSS的形式很紧张. 现在正处在报名阶段，请武林人士快点到襄阳或者诛仙镇进入或者使用宋金诏书进入报名处，报名时间还有:"..RestMin.."分钟"..RestSec.." 秒.参加条件：登记不低于40级,报名费 100000 两";
	AddGlobalNews(str1);
