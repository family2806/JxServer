...
-- ÆÕÍ¨BOSS±í: NPCID¡¢BOSSµÈ¼¶¡¢BOSSÎåĞĞ¡¢BOSSÃû³Æ¡¢BOSSÌ×ÓÃµÄÄ£°æ£¨ÎŞÊµ¼Ê×÷ÓÃ£©
...
function BattleBoss_AddAllCommonBoss()
	...
	Msg2MSAll(MISSIONID, "<color=yellow>Tèng Kim chiÕn b¸o: Mçi bªn Tèng Kim sÏ cö ra 9 vŞ t­íng qu©n cña tõng ph¸i ®Ó tiÕp viÖn!");
end

-- Ë«·½¸÷×ÔÔÚÖĞÂ·Ôö¼Ó3¸öÆÕÍ¨BOSS
function BattleBoss_AddSomeCommonBoss()
	...
	Msg2MSAll(MISSIONID, "<color=yellow>Tèng Kim chiÕn b¸o: Mçi bªn Tèng Kim sÏ cö ra 3 vŞ t­íng qu©n cña tõng ph¸i ®Ó tiÕp viÖn!");
end
...
-- nBossCamp:	BossµÄÕóÓª 1ÎªTèng 2ÎªKim
-- nBossPosID:	BossµÄÎ»ÖÃID 0ÎªÖ÷Óª£¬1-9 ·Ö±ğÎªÓªÍâµÄ×óÖĞÓÒÈıÂ·
...
function OnDeath(nNpcIndex)
	...
	-- È·ÈÏÉ±ËÀµÄBOSSµÄÀà±ğ 0:´íÎó 1:ÆÕÍ¨BOSS 2:BigBoss
	...
	Msg2Player(format("§Ó tÆng th­ëng cho chiÕn c«ng giÕt BOSS, c¸c h¹ thu ®­îc phÇn th­ëng %d ®iÓm tİch lòy!", nPointAward));
