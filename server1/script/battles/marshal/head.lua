...
MS_TOTALPOINT_S = 19		--±¾´ÎÕ½ÒÛ½áÊøÊ±ÇëÁã£¬¼ÇÂ¼±¾´ÎÕ½ÒÛPhe Tèng×Ü»ı·Ö
MS_TOTALPOINT_J = 20		--±¾´ÎÕ½ÒÛ½áÊøÊ±ÇëÁã£¬¼ÇÂ¼±¾´ÎÕ½ÒÛPhe Kim×Ü»ı·Ö
	...
	for i=1,getn(Win_Players_Table) do
        ...
        local n_bonuscff1 = 0;
	   	...
	   	Msg2Player("B¹n nhËn ®­îc "..n_bonuscff1.." ®iÓm tİch lòy")
			...
			Say("¹§Ï²ÄãÔÚ±¾³¡Õ½¶·ÖĞ»ñµÃÊ¤Àû£¬Danh väng cña b¹n t¨ng thªm <color=yellow>"..repute.."<color>®iÓm!²¢µÃµ½¶îÍâµÄ<color=yellow>"..n_bonuscff1.."<color> ®iÓm tİch lòy", 1, "KÕt thóc ®èi tho¹i/#storm_end(1)")
...
if (result == 0) then
--»»±¨Ãû·ÑÎª1¸öÕ½±øÁîÕË»§- Modified by DinhHQ - 20110504
