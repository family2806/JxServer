...
function InitMission()
	...
	BT_SetGameData(GAME_CAMP1, 0) --ÉèÖÃµ±Ç°Phe TèngÈËÊý
	BT_SetGameData(GAME_CAMP2, 0) --ÉèÖÃµ±Ç°Phe KimÈËÊý
...
-------------------------------------------------------------------------
	...
	local str1 = lvlstr.."TrËn ®¸nh Tèng Kim h×nh thøc Th¸p tiÔn ®ang hÕt søc c¨ng th¼ng, tr­íc m¾t ®ang ë giai ®o¹n b¸o danh, nh÷ng ai muèn tham chiÕn xin h·y nhanh chãng ®Õn T­¬ng D­¬ng hoÆc Chu Tiªn trÊn ®¨ng ký b¸o danh; HoÆc sö dông Tèng Kim chiªu th­ ®Ó nhanh chãng ®Õn ®iÓm b¸o danh, thêi gian b¸o danh cßn:"..RestSec.."phót";
	AddGlobalNews(str1);
