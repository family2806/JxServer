...
function main(sel)
	...
	if (UTask_wd == 50*256+50) then 
		Talk(3, "select", "Nhµ ta kh«ng cßn g× ®Ó ¨n, nh×n con nhá lu«n miªng kªu ®ãi, lµm mÑ ta thËt rÊt ®au lßng!", "§¹i tÈu, ta ®©y cã 1 v¹n l­îng. TÈu mau nhËn ®i! ChØ cÇn cã ®Ö tö Vâ §ang ta ®©y, c¸c ng­êi sî kh«ng ph¶i chÞu ®ãi l¹nh n÷a!", "¸i da,ta qu¶ lµ gÆp ®­îc bå t¸t sèng råi! Ta ®ang tØnh hay m¬ B©y giê cßn cã ng­êi tèt vËy sao?")
