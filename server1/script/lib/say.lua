...
function __saypage(n_from, n_total, n_perpage, str_function, str_parameter)
	...
	local tb_newoptions = {}
	if (n_from > 1) then
		tb_newoptions[getn(tb_newoptions)+1] = "上一页/#__saypage("..(n_from-n_perpage)..","..n_total..","..n_perpage..",\""..str_function.."\",\""..str_parameter.."\")"
	end
	if (n_to < n_total) then
		tb_newoptions[getn(tb_newoptions)+1] = "下一页/#__saypage("..(n_from+n_perpage)..","..n_total..","..n_perpage..",\""..str_function.."\",\""..str_parameter.."\")"
	end
