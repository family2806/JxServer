		...
		tbitem = {
			{
				...
				tbrandomitem =
				{
					...
					tbitem = 
					{
						...
						{G=6,D=1,P=1181,LV=1,szname="ÌØ±ğTiªn Th¶o Lé "	 ,prob=1.0	},					
					}
				} 
			},
...
function tbclassname:check_date()--ÅĞ¶ÏÊ±¼ä
...
function tbclassname:sdl_writelog(sztitle,szevent)	--¼ÇÂ¼,sztitle=ÊÂ¼şÃû,szevent=ÊÂ¼şÄÚÈİ
