...
function tbVnRingUpgrade:SelectOption1(strRingType, nLevel)
	...
	if nLevel > 4 then
		...
		CreateNewSayEx(format("N©ng c p nh…n <color=yellow>%s<color> l™n  c p <color=yellow>%d<color>  cho ph–p c∏c hπ tÔy ˝ ch‰n kh∏ng vµ hi÷u ¯ng cho nh…n cÒa m◊nh, xin h∑y l˘a ch‰n kh∏ng t›nh:", strRingName, nLevel), tbOpt)
	end
end
...
--		{format("Ta c„ nh…n c p %d", 10), tbVnRingDowngrade.SelectOption1, {tbVnRingDowngrade, strRingType, 10}},
	...
	CreateNewSayEx("Ch¯c n®ng hπ c p nh…n <color=yellow>[Tinh X∂o] V´ Danh<color> giÛp c∏c hπ hu˚ b· kh∏ng t›nh vµ hi÷u ¯ng cÒa t t c∂ c∏c nh…n <color=yellow>[Tinh X∂o]<color> c p 4 trÎ l™n vµ Æ≠a nh…n v“ c p 3, tı Æ©y c∏c hπ c„ th” dÔng ch¯c n®ng n©ng c p Æ” ch‰n lπi kh∏ng t›nh vµ hi÷u ¯ng cho nh…n cÒa m◊nh. ß” vi÷c hπ c p Æ≠Óc thµnh c´ng, tr≠Ìc ti™n ta c«n bi’t thuÈc t›nh cÒa nh…n c∏c hπ nh≠ th’ nµo?", tbOpt)
end
