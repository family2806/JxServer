...
tbConfig[3] =
{
	...
	tbActition = 
	{
		{"PlayerFunLib:GetItem",	{{tbProp={6,1,30118,0,0,0},nExpiredTime=nItemExpiredTime,},10,"Event_—©–«–«\tV≠Ót qua ∂i 17"} },
	},
}
tbConfig[4] =
{
	...
	tbActition = 
	{
		{"PlayerFunLib:GetItem",	{{tbProp={6,1,30118,0,0,0},nExpiredTime=nItemExpiredTime,},10,"Event_—©–«–«\tV≠Ót qua ∂i 28"} },
	},
}
tbConfig[5] = 
{
	...
	tbActition = 
	{
		{"PlayerFunLib:GetItem",	{{tbProp={6,1,30118,0,0,0},nExpiredTime=nItemExpiredTime,},20,"Event_—©–«–«\tHoµn thµnh Phong L®ng ßÈ"} },
	},
}
tbConfig[6] = --…± ÷boss
{
...
tbConfig[7] = --ÀŒΩ1000µ„
{
	...
	tbCondition = 
	{
		...
		--{"PlayerFunLib:CheckTaskDaily",	{nTSK_DAILY_TK_¡Ï_±˘_ Ø,4,"","<"} },
	},
	tbActition = 
	{
		--{"PlayerFunLib:AddTaskDaily",	{nTSK_DAILY_TK_¡Ï_±˘_ Ø,4} },
...
tbConfig[24] = --ÀÕTuy’t B®ng Tinh c p 1
{
	nId = 24,
	szMessageType = "CreateCompose",
...
tbConfig[25] = --ÀÕTuy’t B®ng Tinh c p 2
{
	nId = 25,
	szMessageType = "CreateCompose",
...
tbConfig[26] = --ÀÕTuy’t B®ng Tinh c p 3
{
	nId = 26,
	szMessageType = "CreateCompose",
...
tbConfig[27] = --ÀÕTuy’t B®ng Tinh c p 4
{
	nId = 27,
	szMessageType = "CreateCompose",
...
tbConfig[28] = --ÀÕTuy’t B®ng Tinh c p 5
{
	nId = 28,
	szMessageType = "CreateCompose",
...
tbConfig[29] = --ÀÕTuy’t B®ng Tinh c p 6
{
	nId = 29,
	szMessageType = "CreateCompose",
...
tbConfig[30] = --ÀÕTuy’t B®ng Tinh c p 7
{
	nId = 30,
	szMessageType = "CreateCompose",
...
tbConfig[31] = --ÀÕTuy’t B®ng Tinh c p 8
{
	nId = 31,
	szMessageType = "CreateCompose",
...
tbConfig[32] = --ÀÕTuy’t B®ng Tinh c p 9
{
	nId = 32,
	szMessageType = "CreateCompose",
...
tbConfig[33] = --ÀÕTuy’t B®ng Tinh c p 10
{
	nId = 33,
	szMessageType = "CreateCompose",
...
tbConfig[34] = --ÀÕTuy’t B®ng Tinh c p 11
{
	nId = 34,
	szMessageType = "CreateCompose",
...
tbConfig[35] = --ÀÕTuy’t B®ng Tinh c p 12
{
	nId = 35,
	szMessageType = "CreateCompose",
