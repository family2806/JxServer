...
local _GetGatherObj = function(nNpcIndex, dwNpcId)
	...
	tbAwardTemplet:GiveAwardByList({szName=tbTask.szGatherName,tbProp={tbTask.tbItem[1], tbTask.tbItem[2],tbTask.tbItem[3],1,0,0}, nBindState=-2, nExpiredTime=60}, format("每日收集任务%s",tbTask.szGatherName));
