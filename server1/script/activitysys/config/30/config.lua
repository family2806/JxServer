...
tbConfig[6] = --Ò»¸öÏ¸½Ú
{
	...
	tbActition = 
	{
		...
		{"PlayerFunLib:GetItem",	{{tbProp={6,1,3040,1,0,0},nExpiredTime=20111201,},15,"Event_NhaGiaoVN", "Ñ×µÛ´³¹ý10¹Ø»ñµÃC©y Bót"} },
		{"tbVngTransLog:Write", {"201111_20Thang11/", 16, "Ñ×µÛ´³¹ý10¹Ø", "C©y Bót", 1}},
	},
}
tbConfig[7] = --Ò»¸öÏ¸½Ú
{
...
tbConfig[20] = --Ò»¸öÏ¸½Ú
{
	...
	tbCondition = 
	{
		...
		--{"ThisActivity:CheckTask",	{TSK_HandInBook,nMaxBookCount,format("Ä¿Ç°Giao nép Cuèn S¸chÊýÁ¿Î´´ïµ½%s, ²»ÄÜÊ¹ÓÃ",nMaxBookCount),">="} },
	},
	tbActition = 
	{
