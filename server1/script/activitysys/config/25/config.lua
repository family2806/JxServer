...
tbConfig[7] = --Ò»¸öÏ¸½Ú
{
	nId = 7,
	szMessageType = "nil",
	szName = "Ê¹ÓÃChïy B¹c Nguyªn §¶nºÍ½ð´¸»ñÈ¡½±ÀøÒÑ´ï200´Î",
	nStartDate = nil,
	nEndDate  = nil,
	tbMessageParam = {nil},
	tbCondition = 
	{
		{"PlayerFunLib:CheckTotalLevel",	{80,"default",">="} },
		{"ThisActivity:CheckTask",	{TaskVarIdx_UseSilverHammerTime,200,"´óÏÀÃ»ÓÐÊ¹ÓÃ¹»200´ÎChïy B¹c Nguyªn §¶nºÍ½ð´¸£¬¼ÌÐø¼ÓÓÍÅ¶",">="} },
		{"ThisActivity:CheckTask",	{TaskVarIdx_IsGet300Award,0,"B¹n ®·  lÜnh th­ëng råi","=="} },
	},
	tbActition = 
	{
		{"PlayerFunLib:AddExp",	{Get300Award,1,"Ê¹ÓÃChïy B¹c Nguyªn §¶nºÍ½ð´¸»ñÈ¡½±ÀøÒÑ´ï200´Î "} },
...
tbConfig[24] = --Ò»¸öÏ¸½Ú
{
	...
	tbActition = 
	{
		...
		{"AddDialogOpt",	{"ÁìÈ¡Chïy §ång Nguyªn §¶n",19} },
	},
}
tbConfig[25] = --Ò»¸öÏ¸½Ú
{
	...
	tbActition = 
	{
		{"AddDialogOpt",	{"ÁìÈ¡Chïy B¹c Nguyªn §¶n",15} },
	},
}
