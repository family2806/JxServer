...
function pActivity:UseCake(nTask,nLimit,nRes)
	...
	if(nCount == nLimit)then
		tbAwardTemplet:Give(%tbAward_Ext["award1500"], 1 , {%EVENT_LOG_TITLE, "Ê¹ÓÃË®¹ûbanhkemºÍÇÉ¿ËÁ¦banhkem1500"})
	end
	--ÌØ±ğ½±Àø
	...
	if nRes == 1 then
			local tbLog50 =  %tbItemOtherAward["use50banhkem"][nCount] or "Ê¹ÓÃbanhkemµÄ·şÎñÆ÷½±Àø"
