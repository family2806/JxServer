...
Award_A = 
{
	...
	{szName="Hoµng Kim Ên (Nh­îc hãa)",tbProp={0,3211},nCount=1,nRate=0.1,nQuality = 1,nExpiredTime=43200,},
	{szName="Hoµng Kim Ên (Nh­îc hãa)",tbProp={0,3221},nCount=1,nRate=0.1,nQuality = 1,nExpiredTime=43200,},
	{szName="Hoµng Kim Ên (Nh­îc hãa)",tbProp={0,3210},nCount=1,nRate=0.2,nQuality = 1,nExpiredTime=43200,},
