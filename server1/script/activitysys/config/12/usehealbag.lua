...
local tbItem2Skill =
{
	["6,1,3146"] = {tbParam = {462, 30, 1, 3 * 18}, nCD = 3, nTaskIndex = 4},  --加血符
	["6,1,3147"] = {tbParam = {493, 10, 1, 10 * 18}, nCD = 15, nTaskIndex = 5}, --加速符
	["6,1,3148"] = {tbParam = {1008, 1, 1, 7 * 18}, nCD = 15, nTaskIndex = 6},  --格挡符
	["6,1,3149"] = {tbParam = {1206, 1, 1, 10 * 18}, nCD = 15, nTaskIndex = 7}, --隐身符
}
