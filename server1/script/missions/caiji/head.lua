...
PLANT_LIST = 
{
	["yellow"] = {nNpcId = 1930, nLevel = 1, szName = "L骯 V祅g", szScriptPath = "\\script\\missions\\caiji\\plant.lua"},
	["green"] = {nNpcId = 1931, nLevel = 1, szName = "L骯 Xanh", szScriptPath = "\\script\\missions\\caiji\\plant.lua"},
}
