...
function pTask:OnStart()
	...
	self.m_BossIndex = FightNpcManager:AddNpc("霍炎炎", 1722, mapid, pos_boss.x, pos_boss.y, self, 0, 1, 1)
	local nNpcIndex = FightNpcManager:GetNpcIndex(self.m_BossIndex)
	SyncNpc(nNpcIndex)
	NpcChat(nNpcIndex, "我烧，我烧，我烧，烧烧烧。")
	self.m_Pillars = {}
	for i = 1, 3 do
		local nNpcIndex = FightNpcManager:AddNpc("柱子", 1723, mapid, pos_pillar[i].x, pos_pillar[i].y, self, i, 1, 1)
