...
local tbNpcList = 
{
	{szName = "鬼谷(1 点)", nNpcId = 1892, nRank = 1, nRate = 19},
	{szName = "漠公(2 点)", nNpcId = 1893, nRank = 2, nRate = 19},
	{szName = "天顺 (4 点)", nNpcId = 1894, nRank = 3, nRate = 14},
	{szName = "尚贤 (7 点)", nNpcId = 1895, nRank = 4, nRate = 10},
	{szName = "飞乐 (10 点)", nNpcId = 1896, nRank = 5, nRate = 9},
	{szName = "馨竹(20 点)", nNpcId = 1897, nRank = 6, nRate = 7},
	{szName = "水经( 30 点)", nNpcId = 1898, nRank = 7, nRate = 5},
	{szName = "山湾(40 点)", nNpcId = 1899, nRank = 8, nRate = 5},
	
	{szName = "踪影(50 点)", nNpcId = 1900, nRank = 9, nRate = 4},
	{szName = "沧澜 (60 点)", nNpcId = 1901, nRank = 10, nRate = 4},
	
	{szName = "啸空(100 点)", nNpcId = 1902, nRank = 11, nRate = 4},
