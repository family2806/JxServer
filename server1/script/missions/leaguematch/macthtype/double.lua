...
WLLS_DATA = {
	...
	npc_mylg = function()
		...
		if (FALSE(n_lid)) then
			wlls_descript("<enter> "..str_des.." thÓ thøc <color=red>song ®Êu tù do<color>. B¹n cã thÓ tù t¹o ®éi hoÆc gia nhËp ®éi kh¸c. "..str_des.." ®èi tho¹i víi quan viªn liªn ®Êu ®Ó ®¨ng ký "..str_des.." nhãm. 1 ®éi tèi ®a <color=red>2 ng­êi<color>",
