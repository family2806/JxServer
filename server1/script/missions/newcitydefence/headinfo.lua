...
RANK_SKILL = 661;		--³ÆºÅ¹â»·
					--ÁÐ±ø	Ð¡§éi tr­ëng	¸±½«	§¹i t­íng 	ÔªË§ Õ¨µ¯³µ
...
tbPlAYERER_ZHANGONG = {     0,   300,   500,  1000,  2000} --´óÓÚ0ÎªBinh sÜ £¬´óÓÚ300ÎªÐ£Î¾....
tbPlAYERER_GUANGHUAN= { {89,   90,   91,   92,   93}, --ËÎ³ÆºÅID
												{94,   95,   96,   97,   98}} --½ð
					--VÖ binh	T­íng qu©n ÊØ³Ç²¿·ÖµÄ¹Ì¶¨npc
...
tbSOLDIER_LEVEL1 = {	95, 95}--ÊØ³Ç¹Ù±øµÄ¼¶±ð
                  --Ð¡Ð£	§éi tr­ëng	Tiªn phong	Chñ t­íng	Chñ so¸i Õ¨µ¯³µ È¡±¦
...
tbDEFENCE_ANNOUNCE = {
			"Íæ¼Ò¿ÉÒÔµ½Thµnh §« Phñ  T­¬ng D­¬ng Phñ  L©m An Phñ  §¹i Lý D­¬ng Ch©u Phñ Óë³ÇÃÅVÖ binh¶Ô»°²Î¼ÓËÎ·½ÊØ³Ç.",
			"Íæ¼Ò¿ÉÒÔµ½Ph­îng T­êng Phñ  BiÖn Kinh Phñ Óë³ÇÃÅVÖ binh¶Ô»°²Î¼Ó½ð·½ÊØ³Ç."
}
...
CALLBOSS_ZHUSHUAI = 120 * 60 * FRAME2TIME / SMALL_TIME;	--Chñ so¸i³öÏÖÊ±¼ä
...
MS_MAXCOUNTNPC_2 = 12;		--§éi tr­ëngÊ£ÓàÊýÁ¿
MS_MAXCOUNTNPC_3 = 13;			--Tiªn phongÊ£ÓàÊýÁ¿
MS_MAXCOUNTNPC_4 = 14;			--Chñ t­íngÊ£ÓàÊýÁ¿
MS_MAXCOUNTNPC_5 = 15;			--Chñ so¸iÊ£ÓàÊýÁ¿
