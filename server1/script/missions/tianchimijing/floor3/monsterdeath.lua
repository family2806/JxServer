...
function OnDeath(nNpcIndex)
	Game:WritePlayerLog(3, "Gi誸 ch誸 qu竔 v藅")
	local tbAward = 
	{
		--DC 天池秘境 - Modifie By DinhHQ - 20120403
		--{nJxb = 100000},
		{nExp = 50000},
	}
	local nBelongerIndex = GetPlayerIndex(nNpcIndex)
	DynamicExecuteByPlayer(nBelongerIndex, "\\script\\lib\\awardtemplet.lua", "tbAwardTemplet:GiveAwardByList", tbAward, "杀死天池秘境第三层的怪物获得奖励.", 1)
end
