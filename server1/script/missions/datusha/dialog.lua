...
function round_award()
	...
	if nRank then
		...
		if nExp then
		 ...
		 Talk(1, "", format("ÄãÕâÕ½µÄThø h¹ng²»ÔÚ %dÃûµ¥ÖÐ", MAX_AWARD_COUNT))
	end	
end
...
function give_award()
	...
	local tbOpt = 
	{
		...
		{"ÎÒÀ´ÁìTæng tÝch lòy½±Àø", final_award},
		{"KÕt thóc ®èi tho¹i"},
	}
...
--	end
	...
	pDungeon:GotoDaTuSha()
	--Ghi log ¼¼ÄÜ key - Modified By DinhHQ -20120410
	if PlayerFunLib:GetTaskDailyCount(2710) == 1 then
...
function dialog_main()
	...
	local tbOpt = 
	{
		{"ÓëLo¹n ChiÕn Cöu Ch©u CècÓÐ¹Ø", about, {0}},
		{"ÎÒÏë¿´ÎÒµÄTæng tÝch lòyºÍÇ°Ê®Thø h¹ng", check_rank},
