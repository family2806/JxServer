...
function main()
	...
	if tbTop10:IsActive() == 1 then
		tbDailog:AddOptEntry("十大高手名单", tbTop10.MainDialog, {tbTop10})
	end	
	--end [DinhHQ]
	--EventSys:GetType("AddNpcOption"):OnEvent(szNpcName, tbDailog, nNpcIndex) --乱战九州谷
	tbDailog:AddOptEntry("斗鱼活动", tbDangBossDailog.Main, {tbDangBossDailog})
