...
--·çÔÆÁîÅÆ°ïÖúÐÂÊÖ- Modified By DinhHQ - 20110916
...
function YDBZ_fun_award_ydmibao(camp, nnpcway)
	--·çÔÆÁîÅÆ×é¶Ó°ïÖúÐÂÊÖ - Modified By DinhHQ - 20110916
	local tbAllPlayers = {}
...
function YDBZ_award_finalboss(camp)
	...
	-- É±ËÀÑ×µÛÐÔÄÜ×îºóboss - Modified - by DinhHQ 20120314
...
function OnDeath(index)
	...
	elseif nband == 50 then							--×îÖÕ´óboss
			...
			-- µ±Ñ×µÛ½áÊøÊ±£¬¹Ø±ÕÑ×µÛ±¦Ïä½±Àø- Modified - by AnhHH 20110726
