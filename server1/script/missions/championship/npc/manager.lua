...
print("bid back bid")
	...
	WriteLog(date("%Y-%m-%d %H:%M:%S").." "..GetAccount()..", ["..GetName().."]tiÕp tôc tranh chøc"..fee.."v¹n l­îng. ÏÖÔÚ×ÜÊýÎª"..TongBid.."v¹n l­îng.");
		Say("Sè tiÒn tranh chøc lÇn nµy cña b¹n lµ "..fee.."v¹n l­îng. ÏµÍ³ÒÑ¼ÇÂ¼ÏÂÄãµÄÃû×Ö£¬×Ê½ðÊýºÍÕË»§£¬²Î¼Ó¾º±êµÄ²Ù×÷ÒÑÍê³É¡£µ½ÏÖÔÚ£¬ÄãµÄ¾º±ê×Ü×Ê½ðÎª"..TongBid.."v¹n l­îng.", 0);
		Msg2SubWorld("Ng­êi ch¬i <color=blue> "..GetName().."<color> Võa míi tham dù tranh chøc Tæng l·nh ®éi cña khu vùc")
	return 1
end
