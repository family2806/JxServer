...
function main()
	...
	for i = 1, getn(CP_MAPTAB) do
		...
		if (mapindex < 0) then
			...
			str = date("%mth¸ng%dngµy").."§¹i héi vâ l©m"..CP_MAPTAB[i][3].."M«n ph¸i ®Êu dù tuyÓn ®· b¾t ®Çu, mêi ®Õn Héi tr­êng vâ l©m ®¹i héi ë L©m An b¸o danh thi ®Êu. §iÒu kiÖn b¸o danh: §¼ng cÊp lín h¬n cÊp 90, sè lÇn tham gia ph¶i Ýt h¬n 20 lÇn. LÇn ®Çu b¸o danh nép 10 v¹n l­îng."
