...
----½«Trang bŞ Hoµng Kim´òÔì³ÉTrang bŞ B¹ch Kim
...
function do_upgoldeq_preview(nItemCount)
	...
	-- ÅĞ¶ÏTrang bŞ Hoµng KimÊÇ·ñ·ûºÏÒªÇó
...
function do_upgoldeq_process(nItemCount)
	...
	for i = 1, nItemCount do
		...
		if (nCurItemQuality == 1) then
			...
			-- ÅĞ¶ÏTrang bŞ Hoµng KimÊÇ·ñ·ûºÏÌõ¼ş
...
function do_upplatinaeq_process(nItemCount)
	...
	-- ÏÈ±éÀúÒ»±é ÕÒµ½ĞèÒªÉı¼¶µÄTrang bŞ B¹ch Kim»òÕßĞèÒª´òÔìµÄTrang bŞ Hoµng Kim
	for i = 1, nItemCount do
		local nCurItemIdx 		= GetGiveItemUnit(i);
		local nCurItemQuality	= GetItemQuality(nCurItemIdx);
		local tbCurItemProp 	= pack(GetItemProp(nCurItemIdx));
...
----½«Trang bŞ Hoµng Kim´òÔì³ÉTrang bŞ B¹ch Kim END
...
-- new func
-- ÅĞ¶Ï¸øÓè½çÃæÖĞµÄ°×½ğ»òÕßTrang bŞ Hoµng KimÊÇ·ñÊÇ´æÔÚ²¢ÇÒÎ¨Ò»
...
-- ²ÎÊı£º²ÄÁÏIdx£¬ÊÇ·ñÎªÔ¤ÀÀ£¬²ÄÁÏtable£¬Trang bŞ Hoµng Kimidx
