...
--	Task0025 = GetTaskTemp(25)			-- ´òÄ¾×®/É³´ü/Ä¾ÈË¼ÆÊý(ÁÙÊ±±äÁ¿)
	...
	if ( Uworld1067 < 10 ) and ( Uworld1000 > 200 ) then		
		...
		--Describe(DescLink_WuShi.."<#>:D¹o nµy kh«ng hiÓu sao l¹i cã nhiÒu ng­êi ®Õn t×m ta thÕ! §õng nãi lµ ng­¬i còng t×m ta nhÐ!",
		--4,"Ta ®ang lµm nhiÖm vô S¬ nhËp, ®Õn t×m ng­êi xin gióp ®ì!/education_wushi",
		--"Ta ®ang cã nhiÖm vô b¸n thÞt t­¬i/education_collectmeat",
