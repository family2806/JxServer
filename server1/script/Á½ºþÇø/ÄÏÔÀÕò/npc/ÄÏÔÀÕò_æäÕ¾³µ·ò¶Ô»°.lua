...
--		SetTask(15, 1)
--	else
		Say("Lµm nghÒ Xa phu thËt lµ khæ cùc, cã lóc ®Õn ch¸o tr¾ng còng kh«ng cã mµ ¨n!", 4, "Nh÷ng n¬i ®· ®i qua/WayPointFun", "Nh÷ng thµnh thŞ ®· ®i qua/StationFun", "Trë l¹i ®Şa ®iÓm cò/TownPortalFun", "Kh«ng cÇn ®©u/OnCancel");
--	end
end;
...
function yes()
	...
	if (Task0013 < 10) then			--Ã»ÓĞÉ±µ½Ê®Ö»ºÚÒ¶ºï
		...
		SetTaskTemp(13, 0)
		Say("C¶m ¬n ng­¬i ®· b¾t dïm ta H¾c DiÖp HÇu! Ta ®­a ng­¬i ®i miÔn phİ!", 4, "Nh÷ng n¬i ®· ®i qua/WayPointFun", "Nh÷ng thµnh thŞ ®· ®i qua/StationFun", "Trë l¹i ®Şa ®iÓm cò/TownPortalFun", "Kh«ng cÇn ®©u/OnCancel")
	end
end;
