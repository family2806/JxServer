...
function yes()
	if (GetFaction() == "tianwang") then						--Èç¹ûÍæ¼ÒÊÇtianwangµÜ×Ó£¬×ø´¬²»ÊÕÇ®
		Say("Huynh ®Ö! Ngåi ch¾c nhÐ!", 2, "§­îc råi! /ok1","Kh«ng rêi ®¶o /no")
	else
	Say("ÌìÍõ°ïÖÚ£º²»ÊÇ±¾°ïÐÖµÜ£¬×ø´¬¿É²»ÊÇÃâ·ÑµÄ¡£", 1, "§­îc. /ok2")
	end
end;

function yes1()
if (GetFaction() == "tianwang") then						--Èç¹ûÍæ¼ÒÊÇtianwangµÜ×Ó£¬×ø´¬²»ÊÕÇ®
	Say("Thanh La §¶o kh«ng ph¶i lµ n¬i dÔ vµo! Ng­¬i chuÈn bÞ s½n sµng ch­a?", 1, "ChuÈn bÞ xong råi /ok3")
else	
	Say("ÌìÍõ°ïÖÚ£º²»ÊÇ±¾°ïÐÖµÜ£¬×ø´¬¿É²»ÊÇÃâ·ÑµÄ¡£", 1, "ºÃ°É/ok4")
end;
end;
