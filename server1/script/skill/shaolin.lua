...
SKILLS={
	...
	yijin_jing={ --易筋经
		...
		lifemax_yan_p={{{1,21},{25,160},{26,160}},{{1,-1},{30,-1}}}
	},
	rulai_qianye={ --如来千叶
	...
	gunshaolin150={ --棍少林150
		...
		skill_desc=
			function(level)
				return "附加第二式<color=blue>韦陀护法<color>以<color=orange>"..floor(100 -Link(level,SKILLS.gunshaolin150.missle_missrate[1])).."%<color>概率造成敌人受伤动作\n"
			end,
		skill_eventskilllevel={{{1,1},{20,20}}},
		skill_startevent={
			[1]={{1,1},{20,1}},
