...
SKILLS={
	...
	tianren_daofa={ --ÌìÈÌµ¶·¨
		addfiremagic_v={{{1,15},{20,530}},{{1,-1},{2,-1}}}
	},
	tianren_maofa={ --ÌìÈÌÃ¬·¨
...
--		lifemax_p={{{1,-11},{20,-30},{30,-20},{40,10},{41,10}},{{1,18*45},{30,18*180}}},
		...
		attackspeed_yan_v={{{1,0},{38,0},{39,60},{40,60}},{{1,18*120},{30,18*360}}},
	...
	tianren120={ --ÌìÈÌ120¼¶¼¼ÄÜ
		...
		skill_desc=
			function(level)
				...
				"ÆïÂíÊ©Õ¹Thêi gian kh«i phôc chiªu thøc: <color=orange>"..floor(Link(level,SKILLS.tianren120.skill_mintimepercastonhorse_v[1]) / 18).." gi©y<color>\n"..
